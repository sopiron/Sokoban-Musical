...
public interface NivelFactory {
    ...
    Caja crearCajaFragil(Posicion posicion);
    Caja crearCajaLlave(Posicion posicion);
    Cerrojo crearCerrojo(Posicion posicion);
    MuroCerrado crearMuroCerrado(Posicion posicion);
